...
// GetLogo ...
func (m *MockNHLAPI) GetLogo(ctx context.Context, logoKey string, logoConf *logo.Config, bounds image.Rectangle) (*logo.Logo, error) {
...
func (m *MockNHLAPI) logoSources(ctx context.Context) (map[string]image.Image, error) {
...
// GetWatchTeams ...
func (m *MockNHLAPI) GetWatchTeams(teams []string) []string {
	for _, t := range teams {
		if t == "ALL" {
...
// NewMock ...
func NewMock(logger *zap.Logger) (*MockNHLAPI, error) {
	// Load Teams
