...
func getLogos() (map[string]*logoInfo, error) {
	...
	readers, err := logoSources()
	if err != nil {
		return nil, err
	}

	l[ANA+"_HOME"] = &logoInfo{
		logo:      logo.New(NYI, readers[NYI], logoCacheDir, 0.8),
		xPosition: -22,
		yPosition: 3,
	}
	...
	l[ARI+"_HOME"] = &logoInfo{
		logo:      logo.New(NYI, readers[NYI], logoCacheDir, 1),
		xPosition: -14,
		yPosition: 0,
	}
	...
	l[LAK+"_HOME"] = &logoInfo{
		logo:      logo.New(NYI, readers[NYI], logoCacheDir, 0.9),
		xPosition: -1,
		yPosition: 2,
	}
	...
	l[WSH+"_HOME"] = &logoInfo{
		logo:      logo.New(NYI, readers[NYI], logoCacheDir, 1.2),
		xPosition: -5,
		yPosition: 3,
	}
